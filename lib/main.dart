        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              onTap: () {
                final problemId = '${key}_$index'; // ← この行を追加
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ProblemDetailScreen(
                      ...
                      unit: unit,
                      // ← 追加
                      recordManager: recordManager, // ← 追加
                    ),
                  ),
                );
              },
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 10),
                  Text('totalAttempts: $totalAttempts'),
                  Text('totalAttempts == 0: ${totalAttempts == 0}'),
                  Text('reviewProblems.length: ${reviewProblems.length}'),
                  Text('reviewProblems.isEmpty: ${reviewProblems.isEmpty}'),
